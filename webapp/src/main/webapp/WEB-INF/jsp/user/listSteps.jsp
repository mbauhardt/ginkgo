    ...
    <div id="main">
      ...
      <div id="col3">
        <div id="col3_content" class="clearfix">
          ...
          <thead>
            <tr><th scope="col" colspan="4"><a href="editStep.html">Add Step</a></th></tr>
          </thead>
          <tbody>
            <tr>
            ...
            <tr>
                <th scope="row" class="sub">${step.stage.name}</th>
                <td>${step.name}</td>
                <td><a href="editStep.html?id=${step.id}">Edit</a></td>
                <td>
                    <form action="deleteStep.html" method="POST">
