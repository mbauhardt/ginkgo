    ...
    <div id="main">
      ...
      <div id="col3">
        <div id="col3_content" class="clearfix">
          ...
          <h2>Edit Stage</h2>
          <form:form method="post" action="editStage.html"  modelAttribute="stageCommand" cssClass="yform">
            <fieldset>
              <legend>Stage</legend>
              <div class="type-text">
              ...
              <div class="type-select">
                <label for="name">Build Plan</label>
                <form:select path="buildPlan"> 
                    <form:option value="-" label="--Please Select"/> 
                    <form:options items="${buildPlans}" itemValue="id" itemLabel="name"/> 
                </form:select> 
              </div>
            </fieldset>
