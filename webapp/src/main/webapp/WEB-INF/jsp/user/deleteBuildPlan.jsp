        ...
        <div id="doc" class="yui-t1">
            ...
            <div id="bd">
                ...
                <div id="yui-main">
                    <div class="yui-b">
                        <div id="editStep">
                        	<div class="hd">Are you sure to delete Build Plan '${buildPlan.name}'?</div>
                        	<div class="bd">
                                <form method="post" action="deleteBuildPlan.html">
                                    <input type="hidden" name="buildPlanId" value="${buildPlan.id}" />
